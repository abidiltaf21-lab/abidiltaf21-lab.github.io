    ...
    const handleLogoUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        xhr.onload = () => {
            if (xhr.status === 200) {
                ...
                toast.error('Upload error. Check Cloudinary settings.');
            }
        ...
        const ml = cloudinary.createMediaLibrary(
            ...
            },
            {
                insertHandler: (data: { assets?: { secure_url?: string; resource_type?: string }[] }) => {
                    ...
                    setSettings((prev) => ({ ...prev, logoUrl: asset.secure_url }));
                                ...
                                <div className="d-flex gap-2">
                                        ...
                                        onClick={() => {
                                            ...
                                            const ml = (window as any).cloudinary.createMediaLibrary({
                                                ...
                                                insertHandler: (data: any) => {
                                                    const asset = data.assets[0];
                                                    setSettings({ ...settings, heroVideoUrl: asset.secure_url });
                                    ...
                                    <input 
                                        ...
                                        onChange={async (e) => {
                                            ...
                                            formData.append('upload_preset', 'smooothpixel_upload');
